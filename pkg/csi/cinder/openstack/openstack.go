...
type IOpenStack interface {
	...
	CreateVolume(name string, size int, vtype, availability string, snapshotID string, sourcevolID string, dssID string, tags *map[string]string) (*volumes.Volume, error)
...
func CreateOpenStackProvider() (IOpenStack, error) {
	...
	logcfg(cfg)
	klog.Infof("NewOpenStackClient: %v", cfg.Global)
