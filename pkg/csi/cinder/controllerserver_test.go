...
func TestCreateVolume(t *testing.T) {
	...
	// mock OpenStack
	properties := map[string]string{"evs.csi.huaweicloud.com/cluster": FakeCluster}
	...
	fakeReq := &csi.CreateVolumeRequest{
		...
		AccessibilityRequirements: &csi.TopologyRequirement{
			Requisite: []*csi.Topology{
				{
					Segments: map[string]string{"topology.evs.csi.huaweicloud.com/zone": FakeAvailability},
				},
			},
		},
	}
...
func TestCreateVolumeWithExtraMetadata(t *testing.T) {
	...
	properties := map[string]string{
		"evs.csi.huaweicloud.com/cluster": FakeCluster,
