...
| properties                     | evs.csi.huaweicloud.com/cluster='kubernetes', readonly='False' |
...
metadata:
  annotations:
    pv.kubernetes.io/provisioned-by: evs.csi.huaweicloud.com
  name: pvc-ba482e24-2e76-48fd-9be5-504724922185
spec:
  accessModes:
  - ReadWriteOnce
  ...
  csi:
    driver: evs.csi.huaweicloud.com
    volumeAttributes:
      storage.kubernetes.io/csiProvisionerIdentity: 1606744152466-8081-evs.csi.huaweicloud.com
...
metadata:
  annotations:
    volume.beta.kubernetes.io/storage-provisioner: evs.csi.huaweicloud.com
  name: sib
  namespace: sib
spec:
  accessModes:
